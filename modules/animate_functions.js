...
export class animation{//takes frames of an animation and positive numbers indicating wait time
	...
	static import(svg_file_element,instructions){//input: string_id and int
		//takes svg file (from inkscape) and converts it into animation object
		//Each layer(group) is treated as a seperate frame.
		//instructions is a text file programing the animation
		//the position of each vector will be goten relative to the 
		//center of the canvas, for ease of motion
		
		var e=document.getElementById(svg_file_element);
